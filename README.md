...
- Included **Miniaudio** and **OpenAL-Soft** Backends  
...
#### Build and Install Steps for Visual Studio 2022 (MSVC)  
- Get the code
...
- Open the directory using Visual Studio 2022
    ...
    - You can right-click on the folder, click on the `Open with Visual Studio 2022` option, if you have context menus activated for VS2022
...
# Testing  
After you've [built](#requirements-and-building) the project, you can test if it works with the test application.
